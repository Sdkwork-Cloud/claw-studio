...
- Published `@sdkwork/core-pc-react` to the new independent GitHub repository `sdkwork-ai/sdkwork-core` and pinned the release workflow to commit `b30bab1f67a696e903a753000282018ace673e13`.
