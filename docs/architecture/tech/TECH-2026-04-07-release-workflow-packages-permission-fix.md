> Migrated from `docs/step/2026-04-07-release-workflow-packages-permission-fix.md` on 2026-06-24.
...
curl.exe -s https://api.github.com/repos/sdkwork-ai/agent-studio/actions/workflows/release.yml/runs?page_size=5
node scripts/release-flow-contract.test.mjs
pnpm.cmd lint
pnpm.cmd build
```
