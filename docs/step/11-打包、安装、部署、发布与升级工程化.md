...
| 执行模式 | 波次内并行 |
| 前置 | `03` `09` `10` |
| 主写入范围 | `packages/sdkwork-claw-distribution` `packages/sdkwork-claw-install` `scripts/release` `scripts/prepare-openclaw-runtime.mjs` `scripts/sync-bundled-components.mjs` `docs/release/` |
