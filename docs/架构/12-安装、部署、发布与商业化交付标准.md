...
- 当前仓库资源 `manifest` 基线为 `openclawVersion=2026.4.8`、`nodeVersion=22.16.0`、`runtimeId=openclaw`、`platform=windows`、`arch=x64`。
...
- Windows server release bundles现在以真实 `bin/sdkwork-claw-server.exe` 为 smoke 入口，不再只依赖包装脚本。
