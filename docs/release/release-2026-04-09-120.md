# Claw Studio release-2026-04-09-120
...
- Implemented the Step 07 extraction:
  ...
  - rewired `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` so the page now consumes `createOpenClawManagedConfigResetState(...)`
