...
- `node --input-type=module -e "import('./scripts/run-node-typescript-check.mjs').then(({ runNodeTypeScriptChecks }) => runNodeTypeScriptChecks(['packages/sdkwork-claw-infrastructure/src/platform/registry.test.ts']))"`
- `node --input-type=module -e "import('./scripts/run-node-typescript-check.mjs').then(({ runNodeTypeScriptChecks }) => runNodeTypeScriptChecks(['packages/sdkwork-claw-infrastructure/src/platform/serverBrowserBridge.test.ts','packages/sdkwork-claw-infrastructure/src/platform/registry.test.ts']))"`
