...
- Reduced `renderOpenClawProviderDialogs` inside `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` from `307` lines to `59` lines.
- Reduced the full `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` hotspot to `4414` lines on fresh measurement.
