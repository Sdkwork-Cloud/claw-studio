# Claw Studio release-2026-04-09-125
...
- Implemented the Step 07 extraction:
  - updated `packages/sdkwork-claw-instances/src/services/instanceWorkbenchHydration.ts`
  - updated `packages/sdkwork-claw-instances/src/services/instanceWorkbenchHydration.test.ts`
  - rewired `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` so the page now consumes `createInstanceWorkbenchHydrationResetState(...)`
