...
- YELLOW:
  - `pnpm lint`
  - blocked in `check:sdkwork-install` because `.gitmodules` currently uses `git@github.com:Sdkwork-Cloud/hub-installer.git` while the install contract expects `https://github.com/Sdkwork-Cloud/hub-installer`
