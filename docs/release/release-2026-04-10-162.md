...
- Implemented the Step 07 final wrapper-family extraction:
  ...
  - added `packages/sdkwork-claw-instances/src/services/instanceDetailAgentMutationStateSupport.test.ts`
  - added `packages/sdkwork-claw-instances/src/services/instanceDetailWorkbenchLoaderSupport.ts`
  - added `packages/sdkwork-claw-instances/src/services/instanceDetailWorkbenchLoaderSupport.test.ts`
