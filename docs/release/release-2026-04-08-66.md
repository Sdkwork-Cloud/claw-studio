...
- Reduced the full `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` hotspot from `2575` to `2571` lines on fresh measurement, while further shrinking duplicated orchestration shells around provider and managed-config saves.
