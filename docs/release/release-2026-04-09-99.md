...
- Re-baselined the current dirty-worktree Step 07 hotspot profile and reconfirmed that repo-wide lint is still yellow only because of the unrelated `.gitmodules` hub-installer URL mismatch.
