# Claw Studio release-2026-04-09-129
...
- Implemented the Step 07 extraction:
  - added `packages/sdkwork-claw-instances/src/services/openClawChannelPresentation.ts`
  - added `packages/sdkwork-claw-instances/src/services/openClawChannelPresentation.test.ts`
  - updated `packages/sdkwork-claw-instances/src/services/index.ts`
  - rewired `packages/sdkwork-claw-instances/src/pages/InstanceDetail.tsx` so the page now consumes `buildReadonlyChannelWorkspaceItems(...)`
