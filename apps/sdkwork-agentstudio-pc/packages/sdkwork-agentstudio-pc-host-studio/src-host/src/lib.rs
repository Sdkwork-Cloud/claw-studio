...
impl ServerStudioPublicApiProvider {
    ...
    fn project_built_in_instance(&self, raw: Option<Value>) -> Value {
        ...
        let mut baseline = json!({
            ...
            "storage": { "provider": "localFile", "namespace": "agent-studio" },
    ...
    fn normalize_instance(&self, raw: Value, id: &str, built_in: bool) -> Value {
        ...
        object.insert(
            ...
            normalize_storage(
                ...
                if built_in { "agent-studio" } else { id },
    ...
    fn instance_detail(&self, instance: &Value, workbench: Option<Value>) -> Value {
        ...
        json!({
            ...
            "storage": {
                ...
                "namespace": instance.get("storage").and_then(|value| value.get("namespace")).and_then(Value::as_str).unwrap_or("agent-studio"),
                "durable": true,
                "queryable": false,
                "transactional": false,
