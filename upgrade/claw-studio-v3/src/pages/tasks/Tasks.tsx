...
import { Clock, Play, Pause, XCircle, RefreshCw, Plus, MoreVertical, Calendar, MessageSquare, Zap, Trash2, Edit2, AlertCircle } from 'lucide-react';
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              <button onClick={fetchTasks} className="flex items-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-2.5 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors font-medium text-sm shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {/* Total Tasks */}
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl p-6 flex items-center gap-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 leading-none mb-1.5">{stats.total}</div>
                <div className="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Total Tasks</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl p-6 flex items-center gap-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 leading-none mb-1.5">{stats.active}</div>
                <div className="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Active</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl p-6 flex items-center gap-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 leading-none mb-1.5">{stats.paused}</div>
                <div className="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Paused</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl p-6 flex items-center gap-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 leading-none mb-1.5">{stats.failed}</div>
                <div className="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Failed</div>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-zinc-50/80 dark:bg-zinc-800/80 border-b border-zinc-200 dark:border-zinc-800">
                    <th className="px-6 py-4 text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Task Name</th>
                    <th className="px-6 py-4 text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Schedule</th>
                    ...
                    <th className="px-6 py-4 text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Next Run</th>
                  ...
                  {tasks.map(task => (
                    <tr key={task.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors group">
                      <td className="px-6 py-4">
                        ...
                        <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 font-mono">{task.id}</div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                          <Calendar className="w-4 h-4 text-zinc-400 dark:text-zinc-500" />
                          <code className="bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-md text-xs font-bold tracking-wider">{task.schedule}</code>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-bold uppercase tracking-wider ${
                          ...
                          <span className={`w-1.5 h-1.5 rounded-full ${
                            task.status === 'active' ? 'bg-primary-500 animate-pulse' :
