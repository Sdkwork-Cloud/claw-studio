...
import { CreditCard, DollarSign, Receipt, TrendingUp, Download, Plus, Server, Sparkles, AlertCircle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800/80 rounded-[1.5rem] p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
          <div>
            ...
            <div className="text-sm text-zinc-500 dark:text-zinc-400 mb-4 font-medium">
              Visa ending in **** 4242
            </div>
          </div>
