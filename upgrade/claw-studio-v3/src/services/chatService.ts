...
export interface IChatService {
  ...
  sendMessageStream(chatSession: any, message: string, model: ChatModel, skill?: Skill, agent?: Agent): AsyncGenerator<string, void, unknown>;
}
...
class ChatService implements IChatService {
  ...
  createChatSession(modelId: string, skill?: Skill, agent?: Agent) {
    let systemInstruction = agent?.systemPrompt || 'You are Claw Studio AI assistant. You help users manage devices, write automation scripts, and answer questions about the ClawHub ecosystem. Keep your answers concise and helpful.';
  ...
  async *sendMessageStream(chatSession: any, message: string, model: ChatModel, skill?: Skill, agent?: Agent): AsyncGenerator<string, void, unknown> {
