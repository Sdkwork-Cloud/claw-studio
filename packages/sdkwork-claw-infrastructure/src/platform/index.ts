...
export type {
  ...
  ProviderClientSetupClientId,
  ProviderClientSetupCompatibility,
  ProviderClientSetupEnvironment,
  ProviderClientSetupEnvironmentShell,
  ProviderClientSetupEnvScope,
  ProviderClientSetupFile,
  ProviderClientSetupFileAction,
  ProviderClientSetupInstallMode,
  ProviderClientSetupModel,
  ProviderClientSetupOpenClawApiKeyStrategy,
  ProviderClientSetupOpenClawInstance,
  ProviderClientSetupOpenClawOptions,
