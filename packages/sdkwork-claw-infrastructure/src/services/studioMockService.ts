  ...
  return [
    {
      ...
      category: 'Automation',
      description:
        'Compose multi-step agent workflows with approvals, retries, and audit trails.',
      banner: 'https://picsum.photos/seed/flowforge-banner/1600/900',
      icon: 'https://picsum.photos/seed/flowforge-icon/256/256',
      rating: 4.9,
      rank: 1,
      reviewsCount: '12.4K',
      screenshots: [
        'https://picsum.photos/seed/flowforge-shot-1/1200/800',
        'https://picsum.photos/seed/flowforge-shot-2/1200/800',
      ],
      version: '2.1.0',
      size: '342 MB',
      releaseDate: '2026-02-22',
      compatibility: 'macOS 12.0+, Windows 11, Ubuntu 22.04',
      ageRating: '4+',
      featured: true,
      topChart: true,
    },
    {
      ...
      category: 'AI Tools',
      description:
        'Compare prompt variants, capture evaluation notes, and manage prompt releases.',
      banner: 'https://picsum.photos/seed/promptboard-banner/1600/900',
      icon: 'https://picsum.photos/seed/promptboard-icon/256/256',
      rating: 4.8,
      rank: 2,
      reviewsCount: '8.1K',
      screenshots: ['https://picsum.photos/seed/promptboard-shot-1/1200/800'],
      version: '1.8.4',
      size: '228 MB',
      releaseDate: '2026-01-15',
      compatibility: 'macOS 12.0+, Windows 11',
      ageRating: '4+',
      topChart: true,
    },
    {
      id: 'app-logscope',
      name: 'LogScope',
      developer: 'Observability Co.',
      category: 'Developer Tools',
      description:
        'Inspect structured logs, traces, and incident timelines in one workspace.',
      icon: 'https://picsum.photos/seed/logscope-icon/256/256',
      rating: 4.7,
      rank: 3,
      reviewsCount: '5.3K',
      screenshots: ['https://picsum.photos/seed/logscope-shot-1/1200/800'],
      version: '3.0.2',
      size: '410 MB',
    ...
    },
    {
      id: 'app-deploydeck',
      name: 'DeployDeck',
      developer: 'CloudNative',
      category: 'DevOps',
      description:
        'Ship builds to Docker, Vercel, and edge targets with one release control plane.',
      icon: 'https://picsum.photos/seed/deploydeck-icon/256/256',
      rating: 4.6,
      screenshots: ['https://picsum.photos/seed/deploydeck-shot-1/1200/800'],
      version: '1.3.6',
      size: '190 MB',
    ...
    },
    {
      id: 'app-agentdesk',
      name: 'AgentDesk',
      developer: 'Operator Studio',
      category: 'Operations',
      description:
        'Run approval inboxes, operator handoffs, and task incident triage from a single panel.',
      icon: 'https://picsum.photos/seed/agentdesk-icon/256/256',
      rating: 4.8,
      screenshots: ['https://picsum.photos/seed/agentdesk-shot-1/1200/800'],
      version: '2.0.0',
      size: '275 MB',
    ...
    },
    {
      ...
      category: 'Productivity',
      description:
        'Shape CSV, SQL, and API payloads into reusable automation-ready datasets.',
      icon: 'https://picsum.photos/seed/databuilder-icon/256/256',
      rating: 4.5,
      screenshots: ['https://picsum.photos/seed/databuilder-shot-1/1200/800'],
      version: '1.1.9',
      size: '160 MB',
  ...
  return [
    {
      ...
      subtitle: 'Core tools for automations, prompts, and daily operations.',
      appIds: ['app-flowforge', 'app-promptboard', 'app-agentdesk'],
    },
    {
      title: 'Ship And Observe',
      subtitle: 'Deployment and diagnostics tools for advanced teams.',
      appIds: ['app-logscope', 'app-deploydeck'],
    },
    {
      title: 'Data Foundations',
      subtitle: 'Prepare the inputs that power reliable automations.',
      appIds: ['app-databuilder', 'app-promptboard'],
    },
  ];
}
