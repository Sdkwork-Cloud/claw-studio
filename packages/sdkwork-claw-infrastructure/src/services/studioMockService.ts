  ...
  return [
    {
      ...
      setupGuide: [
        ...
        'Optional: register a webhook if Telegram should push updates directly to your host.',
        'Enable the channel after validating the token and default target.',
      ],
      fields: [
        {
          key: 'botToken',
          ...
          value: '123456:telegram-bot-token',
        },
        {
          key: 'defaultTo',
          label: 'Default Target',
          type: 'text',
          placeholder: 'channel:ops-room',
          value: 'channel:ops-room',
        },
      ],
    },
    {
      ...
      enabled: false,
      setupGuide: [
        'Open the native OpenClaw console and start WhatsApp QR pairing.',
        'Scan the QR code with the device that OpenClaw should use.',
        'Return here to set the optional default target and message prefix.',
      ],
      fields: [
        {
          key: 'defaultTo',
    ...
    },
    {
      ...
      setupGuide: [
        ...
        'Paste the bot token and optional default target here.',
        'Enable the channel after inviting the bot to the target server.',
      ],
      fields: [
        {
          key: 'token',
    ...
    },
    {
      ...
      setupGuide: [
        ...
        'Set a default channel or nick after validating connectivity.',
      ],
      fields: [
        {
          key: 'host',
    ...
    },
    {
      ...
      setupGuide: [
        ...
        'Provide either the service account JSON or a secret reference.',
        'Fill the webhook path if the deployment expects inbound events.',
      ],
      fields: [
        {
    ...
    },
    {
      ...
      enabled: true,
      setupGuide: [
        'Create or open your Slack app and install it to the workspace.',
        'Paste the bot token and app token here.',
        'Add the signing secret only if your workspace uses HTTP events.',
      ],
      fields: [
        {
          key: 'botToken',
    ...
    },
    {
      ...
      enabled: false,
      setupGuide: [
        'Install or locate signal-cli and pair the device OpenClaw should use.',
        'Provide the Signal number and either the CLI path or REST bridge URL.',
        'Choose a default target if the runtime should reuse the same recipient.',
      ],
      fields: [
        {
          key: 'account',
    ...
    },
    {
      ...
      instanceId: null,
      name: 'iMessage',
      description: 'Route iMessage or SMS conversations through a local or remote macOS host.',
      icon: 'MessageCircle',
      status: 'not_configured',
      enabled: false,
      setupGuide: [
        'Choose a local Messages database or a remote macOS host over SSH.',
        'Provide the helper CLI path or the database path OpenClaw should access.',
        'Set the default service and target before enabling runtime delivery.',
      ],
      fields: [
        {
          key: 'dbPath',
    ...
    },
    {
      ...
      enabled: false,
      setupGuide: [
        'Create a LINE Messaging API channel and copy the token and secret.',
        'Provide the direct values or file references used by the host runtime.',
        'Set the webhook path after the bot is enabled.',
      ],
      fields: [
        {
...
const apiRouterProxyProviderSeeds: ProxyProviderSeed[] = [
  ...
  {
    id: 'provider-minimax-global-route',
    channelId: 'minimax',
    name: 'MiniMax Global Route',
    apiKey: 'minimax-global-route-1037b3a8cc3840d29922',
    groupId: 'shared-core',
    requestCount: 27830,
    tokenCount: 21036780,
    spendUsd: 388.91,
    ...
    notes: 'Global Anthropic-compatible MiniMax M2.7 route for Claude Code, OpenCode, and OpenClaw onboarding.',
  },
  {
    id: 'provider-minimax-cn-route',
    channelId: 'minimax',
    name: 'MiniMax CN Route',
    apiKey: 'minimax-cn-route-4b0c8eb80aa04f32ad57',
    groupId: 'cn-core',
    requestCount: 19340,
    tokenCount: 15410360,
    spendUsd: 271.44,
    ...
    notes: 'CN Anthropic-compatible MiniMax M2.7 route aligned with the current api.minimaxi.com endpoint.',
  },
  {
