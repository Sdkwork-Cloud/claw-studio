!macro NSIS_HOOK_POSTINSTALL
  nsExec::ExecToLog '"$INSTDIR\Claw Studio.exe" --prepare-bundled-openclaw-runtime --install-root "$INSTDIR"'
  Pop $0
  ...
  nsExec::ExecToLog '"$INSTDIR\Claw Studio.exe" --register-openclaw-cli --install-root "$INSTDIR"'
  Pop $0
