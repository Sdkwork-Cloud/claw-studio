...
const MANAGED_ENV_BLOCK_ID: &str = "claw-studio-provider-access-env";

#[derive(Clone, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "kebab-case")]
pub enum ProviderClientSetupClientId {
    Codex,
    ClaudeCode,
    Opencode,
    Openclaw,
...
pub enum ProviderClientSetupCompatibility {
    Openai,
    Anthropic,
    Gemini,
}
...
#[serde(rename_all = "lowercase")]
pub enum ProviderClientSetupInstallMode {
    Standard,
    Env,
    Both,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "lowercase")]
pub enum ProviderClientSetupEnvScope {
    User,
    System,
}
...
pub struct ProviderClientSetupModel {
    pub id: String,
    pub name: String,
}
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupProvider {
    pub id: String,
    pub channel_id: String,
    pub name: String,
    pub base_url: String,
    pub api_key: String,
    pub compatibility: ProviderClientSetupCompatibility,
    pub models: Vec<ProviderClientSetupModel>,
}

#[derive(Clone, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupOpenClawOptions {
    pub instance_ids: Vec<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub api_key_strategy: Option<ProviderClientSetupOpenClawApiKeyStrategy>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "kebab-case")]
pub enum ProviderClientSetupOpenClawApiKeyStrategy {
    Shared,
    PerInstance,
}
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupRequest {
    pub client_id: ProviderClientSetupClientId,
    pub provider: ProviderClientSetupProvider,
    pub install_mode: Option<ProviderClientSetupInstallMode>,
    pub env_scope: Option<ProviderClientSetupEnvScope>,
    pub open_claw: Option<ProviderClientSetupOpenClawOptions>,
}

#[derive(Clone, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "lowercase")]
pub enum ProviderClientSetupFileAction {
    Created,
    Updated,
}
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupFile {
    pub path: String,
    pub action: ProviderClientSetupFileAction,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "lowercase")]
pub enum ProviderClientSetupEnvironmentShell {
    Powershell,
    Sh,
}
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupEnvironment {
    pub scope: ProviderClientSetupEnvScope,
    pub shell: ProviderClientSetupEnvironmentShell,
    pub target: String,
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupOpenClawInstance {
    pub instance_id: String,
    pub endpoint: String,
    pub api_key: String,
    pub api_key_project_id: String,
    pub api_key_strategy: ProviderClientSetupOpenClawApiKeyStrategy,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Eq, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderClientSetupResult {
    pub client_id: ProviderClientSetupClientId,
    pub written_files: Vec<ProviderClientSetupFile>,
    pub updated_environments: Vec<ProviderClientSetupEnvironment>,
    pub updated_instance_ids: Vec<String>,
    pub open_claw_instances: Vec<ProviderClientSetupOpenClawInstance>,
}
...
pub struct ProviderClientSetupService;

impl ProviderClientSetupService {
    pub fn new() -> Self {
        Self
    }
    ...
    ) -> Result<ProviderClientSetupResult> {
    ...
    fn install_client_setup_with_runtime(
        ...
        match request.client_id {
            ProviderClientSetupClientId::Codex => install_codex(&request, runtime),
            ProviderClientSetupClientId::ClaudeCode => install_claude_code(&request, runtime),
            ProviderClientSetupClientId::Opencode => install_opencode(&request, runtime),
            ProviderClientSetupClientId::Openclaw => install_openclaw(&request, paths),
            ProviderClientSetupClientId::Gemini => install_gemini(&request, runtime),
        }
    }
}
...
fn resolve_install_mode(request: &ProviderClientSetupRequest) -> ProviderClientSetupInstallMode {
    request.install_mode.unwrap_or(match request.client_id {
        ProviderClientSetupClientId::Gemini => ProviderClientSetupInstallMode::Standard,
        ProviderClientSetupClientId::Codex
        | ProviderClientSetupClientId::ClaudeCode
        | ProviderClientSetupClientId::Opencode
        | ProviderClientSetupClientId::Openclaw => ProviderClientSetupInstallMode::Standard,
    })
}

fn resolve_env_scope(request: &ProviderClientSetupRequest) -> ProviderClientSetupEnvScope {
    request
        .env_scope
        .unwrap_or(ProviderClientSetupEnvScope::User)
}

fn supports_install_mode(
    client_id: &ProviderClientSetupClientId,
    mode: ProviderClientSetupInstallMode,
) -> bool {
    match client_id {
        ProviderClientSetupClientId::Codex
        | ProviderClientSetupClientId::ClaudeCode
        | ProviderClientSetupClientId::Opencode => {
            matches!(
                mode,
                ProviderClientSetupInstallMode::Standard
                    | ProviderClientSetupInstallMode::Env
                    | ProviderClientSetupInstallMode::Both
            )
        }
        ProviderClientSetupClientId::Gemini => {
            matches!(
                mode,
                ProviderClientSetupInstallMode::Standard
                    | ProviderClientSetupInstallMode::Env
        ...
        ProviderClientSetupClientId::Openclaw => mode == ProviderClientSetupInstallMode::Standard,
    }
}
...
fn build_environment_variables(
    ...
    match request.client_id {
        ProviderClientSetupClientId::Codex => vec![
        ...
        ProviderClientSetupClientId::ClaudeCode => vec![
            EnvVariableAssignment {
        ...
        ProviderClientSetupClientId::Opencode => match request.provider.compatibility {
            ProviderClientSetupCompatibility::Anthropic => vec![
                EnvVariableAssignment {
                    key: ANTHROPIC_AUTH_TOKEN_ENV_KEY.to_string(),
                    value: request.provider.api_key.clone(),
                },
            ...
            ProviderClientSetupCompatibility::Openai => vec![
                EnvVariableAssignment {
                    key: OPENAI_API_KEY_ENV_KEY.to_string(),
                    value: request.provider.api_key.clone(),
                },
            ...
            ProviderClientSetupCompatibility::Gemini => Vec::new(),
        },
        ProviderClientSetupClientId::Gemini => vec![
            EnvVariableAssignment {
        ...
        ProviderClientSetupClientId::Openclaw => Vec::new(),
    }
}

fn validate_request(request: &ProviderClientSetupRequest) -> Result<()> {
    ...
    match request.client_id {
        ProviderClientSetupClientId::ClaudeCode => {
            if request.provider.compatibility != ProviderClientSetupCompatibility::Anthropic {
        ...
        ProviderClientSetupClientId::Codex => {
            if request.provider.compatibility != ProviderClientSetupCompatibility::Openai {
                return Err(FrameworkError::ValidationFailed(
        ...
        ProviderClientSetupClientId::Opencode => {}
        ProviderClientSetupClientId::Openclaw => {
        ...
        ProviderClientSetupClientId::Gemini => {
            if request.provider.compatibility != ProviderClientSetupCompatibility::Gemini {
                return Err(FrameworkError::ValidationFailed(
    ...
    if matches!(
        install_mode,
        ProviderClientSetupInstallMode::Env | ProviderClientSetupInstallMode::Both
...
fn validate_provider(provider: &ProviderClientSetupProvider) -> Result<()> {
...
fn install_codex(
    ...
    if matches!(
        install_mode,
        ProviderClientSetupInstallMode::Standard | ProviderClientSetupInstallMode::Both
    ) {
    ...
    Ok(ProviderClientSetupResult {
        client_id: ProviderClientSetupClientId::Codex,
        written_files,
...
fn install_claude_code(
    ...
    Ok(ProviderClientSetupResult {
        client_id: ProviderClientSetupClientId::ClaudeCode,
        written_files,
        updated_environments,
        updated_instance_ids: Vec::new(),
        open_claw_instances: Vec::new(),
...
fn install_opencode(
    ...
    if matches!(
        ...
        let auth_provider_key = match request.provider.compatibility {
            ProviderClientSetupCompatibility::Openai => {
            ...
            ProviderClientSetupCompatibility::Anthropic => {
            ...
            ProviderClientSetupCompatibility::Gemini => {
                return Err(FrameworkError::ValidationFailed(
    ...
    Ok(ProviderClientSetupResult {
        client_id: ProviderClientSetupClientId::Opencode,
        written_files,
        updated_environments,
        updated_instance_ids: Vec::new(),
        open_claw_instances: Vec::new(),
...
fn install_gemini(
    ...
    Ok(ProviderClientSetupResult {
        client_id: ProviderClientSetupClientId::Gemini,
        written_files,
        updated_environments,
        updated_instance_ids: Vec::new(),
        open_claw_instances: Vec::new(),
...
fn install_openclaw(
    ...
    let mut written_files = Vec::new();
    let mut open_claw_instances = Vec::new();
    ...
    for instance_id in &open_claw.instance_ids {
        ...
        open_claw_instances.push(ProviderClientSetupOpenClawInstance {
            instance_id: instance_id.clone(),
            endpoint: request.provider.base_url.clone(),
            api_key: request.provider.api_key.clone(),
            api_key_project_id: format!("project-{instance_id}"),
            api_key_strategy: open_claw
                .api_key_strategy
                .unwrap_or(ProviderClientSetupOpenClawApiKeyStrategy::Shared),
            selected_provider_id: open_claw.route_provider_id.clone(),
            model_mapping_id: open_claw.model_mapping_id.clone(),
        });
    }
...
fn primary_model(provider: &ProviderClientSetupProvider) -> Result<&ProviderClientSetupModel> {
...
fn write_text_file(path: &Path, content: &str) -> Result<ProviderClientSetupFile> {
    ...
    Ok(ProviderClientSetupFile {
        path: path.to_string_lossy().into_owned(),
        action: if existed {
            ProviderClientSetupFileAction::Updated
        } else {
            ProviderClientSetupFileAction::Created
        },
    })
}
...
fn write_profile_loader(path: &Path, loader: &str) -> Result<ProviderClientSetupFile> {
...
fn resolve_unix_system_env_path(runtime: &InstallerRuntime) -> PathBuf {
    runtime.system_env_dir.join("claw-studio-provider-access.sh")
}
...
fn install_environment_variables(
    ...
    Vec<ProviderClientSetupFile>,
    Vec<ProviderClientSetupEnvironment>,
)> {
...
fn install_powershell_environment(
    ...
    let env_path = match scope {
        ProviderClientSetupEnvScope::User => resolve_windows_user_env_path(&runtime.home_dir),
        ProviderClientSetupEnvScope::System => resolve_windows_system_env_path(runtime),
    };
    let profile_path = match scope {
        ProviderClientSetupEnvScope::User => resolve_windows_user_profile_path(&runtime.home_dir),
        ProviderClientSetupEnvScope::System => resolve_windows_system_profile_path(runtime),
    };
    ...
    Ok((
        ...
        vec![ProviderClientSetupEnvironment {
            scope,
            shell: ProviderClientSetupEnvironmentShell::Powershell,
...
fn install_sh_environment(
    ...
    match scope {
        ProviderClientSetupEnvScope::User => {
            ...
            Ok((
                ...
                vec![ProviderClientSetupEnvironment {
                    scope,
                    shell: ProviderClientSetupEnvironmentShell::Sh,
                    target: env_path.to_string_lossy().into_owned(),
                    variables: variables
                        .iter()
                        .map(|variable| variable.key.clone())
        ...
        ProviderClientSetupEnvScope::System => {
...
fn infer_reasoning_model_id(models: &[ProviderClientSetupModel]) -> Option<String> {
    let keywords = [
...
fn infer_embedding_model_id(models: &[ProviderClientSetupModel]) -> Option<String> {
...
mod tests {
    use super::{
        ...
        resolve_windows_user_profile_path, ProviderClientSetupRequest,
        ProviderClientSetupClientId, ProviderClientSetupCompatibility, ProviderClientSetupEnvScope,
        ProviderClientSetupInstallMode, ProviderClientSetupModel, ProviderClientSetupOpenClawOptions,
        ProviderClientSetupProvider, ProviderClientSetupService, InstallPlatform, InstallerRuntime,
    };
    ...
    ) -> ProviderClientSetupProvider {
        ProviderClientSetupProvider {
            id: "provider-openai-1".to_string(),
            channel_id: match compatibility {
                ProviderClientSetupCompatibility::Openai => "openai".to_string(),
                ProviderClientSetupCompatibility::Anthropic => "anthropic".to_string(),
                ProviderClientSetupCompatibility::Gemini => "google".to_string(),
            },
            ...
            models: vec![
                match compatibility {
                    ProviderClientSetupCompatibility::Gemini => ProviderClientSetupModel {
                        id: "gemini-3.1-pro-preview".to_string(),
                        name: "Gemini 3.1 Pro".to_string(),
                    },
                    ProviderClientSetupCompatibility::Openai
                    | ProviderClientSetupCompatibility::Anthropic => ProviderClientSetupModel {
                        id: "gpt-4.1-mini".to_string(),
                        name: "GPT-4.1 Mini".to_string(),
                    },
                },
                ProviderClientSetupModel {
    ...
    fn installs_codex_config_and_auth_json_for_api_key_flow() {
        ...
        let service = ProviderClientSetupService::new();
...
"#,
    ...
    fn installs_gemini_cli_settings_and_env_files() {
        ...
        let request = ProviderClientSetupRequest {
            ...
            provider: ProviderClientSetupProvider {
                ...
                compatibility: ProviderClientSetupCompatibility::Gemini,
                models: vec![ProviderClientSetupModel {
                    id: "gemini-3.1-pro-preview".to_string(),
                    name: "Gemini 3.1 Pro".to_string(),
                }],
            },
            install_mode: Some(ProviderClientSetupInstallMode::Standard),
            env_scope: None,
            open_claw: None,
        };
        ...
        assert_eq!(settings["model"]["name"], "gemini-3.1-pro-preview");
        assert_eq!(
    ...
    fn installs_both_gemini_standard_and_shell_environment_for_routed_gateways() {
        ...
        let request = ProviderClientSetupRequest {
            ...
            install_mode: Some(ProviderClientSetupInstallMode::Both),
            env_scope: Some(ProviderClientSetupEnvScope::User),
            open_claw: None,
        };
        ...
        assert!(zshrc.contains("claw-studio-provider-access-env"));
    ...
    fn installs_environment_only_shell_setup_for_gemini() {
        ...
        let request = ProviderClientSetupRequest {
            ...
            install_mode: Some(ProviderClientSetupInstallMode::Env),
            env_scope: Some(ProviderClientSetupEnvScope::User),
            open_claw: None,
        };
    ...
    fn installs_environment_only_shell_setup_for_codex() {
        ...
        request.install_mode = Some(ProviderClientSetupInstallMode::Env);
        request.env_scope = Some(ProviderClientSetupEnvScope::User);
    ...
    fn installs_windows_powershell_environment_for_codex_both_mode() {
        ...
        request.install_mode = Some(ProviderClientSetupInstallMode::Both);
        request.env_scope = Some(ProviderClientSetupEnvScope::User);
    ...
    fn installs_system_scope_shell_environment_file_on_linux() {
        ...
        request.install_mode = Some(ProviderClientSetupInstallMode::Both);
        request.env_scope = Some(ProviderClientSetupEnvScope::System);
    ...
    fn rejects_openclaw_environment_only_mode() {
        ...
        request.install_mode = Some(ProviderClientSetupInstallMode::Env);
        request.open_claw = Some(ProviderClientSetupOpenClawOptions {
