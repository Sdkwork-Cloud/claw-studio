...
const spotlightVendorIds = new Set(['default', 'openai', 'minimax']);
...
export function ModelPurchaseSidebar({
  ...
  return (
    <aside
      ...
      className="w-full shrink-0 xl:sticky xl:top-4 xl:w-[18rem]"
    >
      <div className="rounded-[28px] border border-zinc-200/80 bg-white/92 p-3 shadow-[0_18px_48px_rgba(15,23,42,0.08)] backdrop-blur dark:border-zinc-800/80 dark:bg-zinc-950/70">
        ...
        <div className="space-y-4 xl:max-h-[calc(100vh-10rem)] xl:overflow-y-auto xl:pr-1">
          {groups.map((group) => {
