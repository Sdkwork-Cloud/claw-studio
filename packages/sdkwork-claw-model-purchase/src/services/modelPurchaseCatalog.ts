...
const vendorProfiles: VendorProfile[] = [
  ...
  },
  {
    ...
    channelId: 'baichuan',
    tone: 'amber',
    tagline: 'Stable domestic packages for assistant rollouts.',
    heroDescription: 'Balances enterprise procurement with dependable routed access.',
    audience: 'Enterprise assistant rollouts',
    modelHighlights: ['Baichuan', 'Productivity', 'Stable procurement'],
    basePricesCny: [54, 139, 329],
    baseTokensMillions: [45, 150, 445],
  },
  {
    id: 'yi',
    name: '01.AI Yi',
    ...
    channelId: 'yi',
    tone: 'blue',
    tagline: 'General-purpose domestic packages with clean buying structure.',
    heroDescription: 'A flexible lane for mainstream domestic AI applications.',
    audience: 'General-purpose domestic AI apps',
    modelHighlights: ['Yi', 'General purpose', 'Flexible routing'],
    basePricesCny: [52, 136, 318],
    baseTokensMillions: [44, 146, 430],
  },
];
