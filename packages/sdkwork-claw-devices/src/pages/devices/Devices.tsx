    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto h-full overflow-y-auto scrollbar-hide">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {devices.length === 0 ? (
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 border-dashed rounded-3xl p-12 text-center">
              ...
              <button 
                onClick={() => setIsRegisterModalOpen(true)}
                className="bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 px-6 py-2.5 rounded-xl hover:bg-zinc-800 dark:hover:bg-white transition-colors font-medium text-sm inline-flex items-center gap-2"
              >
                <Plus className="w-4 h-4" />
                Register Device
              </button>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs font-mono text-zinc-500 dark:text-zinc-400">{device.id}</span>
