...
import { ArrowLeft, Box, Download, ShieldCheck, FileText, Code, Activity, HardDrive } from 'lucide-react';
...
export function HuggingFaceModelDetail() {
  ...
  const model = HUGGINGFACE_MODELS.find(m => m.id === id);
              ...
              {activeTab === 'files' && (
                <div className="space-y-2 font-mono text-sm">
                  <div className="flex items-center justify-between p-2 hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-lg cursor-pointer">
                    <div className="flex items-center gap-3">
                      <span className="text-zinc-400">📄</span> config.json
                    </div>
                    <span className="text-zinc-500 text-xs">2.4 kB</span>
                  </div>
                  <div className="flex items-center justify-between p-2 hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-lg cursor-pointer">
                    <div className="flex items-center gap-3">
                      <span className="text-zinc-400">📄</span> pytorch_model.bin
                    </div>
                    <span className="text-zinc-500 text-xs">14.2 GB</span>
                  </div>
                  <div className="flex items-center justify-between p-2 hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-lg cursor-pointer">
                    <div className="flex items-center gap-3">
                      <span className="text-zinc-400">📄</span> tokenizer.json
                    </div>
