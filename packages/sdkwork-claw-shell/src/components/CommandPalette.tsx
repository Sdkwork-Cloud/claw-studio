        ...
        >
          <div className="flex items-center px-4 py-4 border-b border-zinc-100 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-1 ml-3">
              <kbd className="px-2 py-1 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded text-xs font-sans font-medium text-zinc-500 dark:text-zinc-400">
                ESC
              </kbd>
            </div>
          </div>
          ...
          <div className="px-4 py-3 bg-zinc-50/50 dark:bg-zinc-900/50 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-1">
                <kbd className="font-sans bg-zinc-200/50 dark:bg-zinc-800/50 px-1.5 py-0.5 rounded">↑</kbd>
                <kbd className="font-sans bg-zinc-200/50 dark:bg-zinc-800/50 px-1.5 py-0.5 rounded">↓</kbd>
                {' '}
                to navigate
              </span>
