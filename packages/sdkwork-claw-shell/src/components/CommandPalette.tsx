...
export function CommandPalette() {
  ...
  const [instances, setInstances] = useState<CommandPaletteInstance[]>([]);
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener(OPEN_COMMAND_PALETTE_EVENT, handleOpen);
  }, []);
        ...
        >
          <div className="flex items-center border-b border-zinc-100 px-4 py-4 dark:border-zinc-800">
            ...
            <Input
              ...
              className="flex-1 border-0 bg-transparent text-lg shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 dark:bg-transparent"
            />
