...
import { User, Bell, Monitor, Shield, Database, Key, Search, Sparkles } from 'lucide-react';
...
export function Settings() {
  ...
  return (
    <div className="flex h-full bg-zinc-50/50 dark:bg-zinc-950/50">
      {/* Settings Sidebar */}
      <div className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/80 backdrop-blur-xl shrink-0 flex flex-col">
        <div className="p-6 pb-4">
          <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight mb-4">Settings</h1>
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-9 pr-4 py-2 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 dark:focus:border-primary-500 transition-all shadow-sm placeholder:text-zinc-400 dark:placeholder:text-zinc-600"
            />
          </div>
        </div>
        <nav className="flex-1 px-3 space-y-1 overflow-y-auto pb-6 scrollbar-hide">
