        ...
        <Section title="Two-Factor Authentication">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <button className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-2 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors text-sm font-medium shadow-sm">
                Enable 2FA
              </button>
            </div>
          </div>
        ...
        <Section title="Active Sessions">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-100 dark:border-zinc-800">
              ...
              <button className="text-sm text-red-600 dark:text-red-500 hover:text-red-700 dark:hover:text-red-400 font-medium">Revoke</button>
            </div>
          </div>
        </Section>
      </div>
