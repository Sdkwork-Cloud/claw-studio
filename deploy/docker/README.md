...
The packaged `deploy/docker-compose*.yml` files resolve env overlays relative to `deploy/` and use the extracted bundle root as the Docker build context for `app/`.
